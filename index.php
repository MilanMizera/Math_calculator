...
<form method="post" action="index.php">
  <div class="form-group row">
    ...
    <div class="col">
      <input value="<?php $num1 ?>" type="text" name="number1" class="form-control" id="inputEmail3" placeholder="Zde zadejte Vaše první číslo">
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input value="<?php $num2 ?>" type="text" name="number2" class="form-control" id="inputPassword3" placeholder="Zde zadejte Vaše druhé číslo">
    </div>
  </div>
